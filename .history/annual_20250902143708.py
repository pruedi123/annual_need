...
# ---- Clean and coerce columns; detect allocation columns ----
allocation_cols = []
if df is not None:
    ...
    if df is None:
        ...
        for column_name in allocation_cols:
            ...
            results_summary.append({
                ...
                'Required Annual Investment': int(required_annual_investment)
            })
        
        # Convert results to a DataFrame for easy viewing
        results_df = pd.DataFrame(results_summary)

        # Standardize allocation names
